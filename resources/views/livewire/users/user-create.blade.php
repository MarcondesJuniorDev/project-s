<div class="px-4 sm:px-6 lg:px-8">
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1" class="text-center sm:text-left">{{ __('Create User') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6 text-center sm:text-left">{{ __('Form for creating new user') }}</flux:subheading>
